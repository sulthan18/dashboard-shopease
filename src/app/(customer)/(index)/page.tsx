                ...
                <div className="container max-w-[1130px] mx-auto flex items-center justify-center gap-10 mt-[50px]">
                    <div className="flex items-center gap-[10px]">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            ...
                            <p className="text-xs leading-[18px]">Jessica Wongso</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-[10px]">
                        <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            ...
                            <p className="text-xs leading-[18px]">Cian Wo</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-[10px]">
                        <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            ...
                            <p className="text-xs leading-[18px]">Christine Malaka</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-[10px]">
                        <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            ...
                            <p className="text-xs leading-[18px]">Ferdino Sarif</p>
                        </div>
                    </div>
                </div>
            </header>
